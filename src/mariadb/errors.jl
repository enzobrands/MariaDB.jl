...
const ER_UNUSED_1 = 1726
const ER_BINLOG_UNSAFE_AUTOINC_NOT_FIRST = 1727
const ER_LAST_MYSQL_ERROR_MESSAGE = 1728
const ER_VCOL_BASED_ON_VCOL = 1900
const ER_VIRTUAL_COLUMN_FUNCTION_IS_NOT_ALLOWED = 1901
const ER_DATA_CONVERSION_ERROR_FOR_VIRTUAL_COLUMN = 1902
const ER_PRIMARY_KEY_BASED_ON_VIRTUAL_COLUMN = 1903
const ER_KEY_BASED_ON_GENERATED_VIRTUAL_COLUMN = 1904
const ER_WRONG_FK_OPTION_FOR_VIRTUAL_COLUMN = 1905
const ER_WARNING_NON_DEFAULT_VALUE_FOR_VIRTUAL_COLUMN = 1906
const ER_UNSUPPORTED_ACTION_ON_VIRTUAL_COLUMN = 1907
const ER_CONST_EXPR_IN_VCOL = 1908
const ER_ROW_EXPR_FOR_VCOL = 1909
const ER_UNSUPPORTED_ENGINE_FOR_VIRTUAL_COLUMNS = 1910
const ER_UNKNOWN_OPTION = 1911
const ER_BAD_OPTION_VALUE = 1912
const ER_NETWORK_READ_EVENT_CHECKSUM_FAILURE = 1913
const ER_BINLOG_READ_EVENT_CHECKSUM_FAILURE = 1914
const ER_CANT_DO_ONLINE = 1915
const ER_DATA_OVERFLOW = 1916
const ER_DATA_TRUNCATED = 1917
const ER_BAD_DATA = 1918
const ER_DYN_COL_WRONG_FORMAT = 1919
const ER_DYN_COL_IMPLEMENTATION_LIMIT = 1920
const ER_DYN_COL_DATA = 1921
const ER_DYN_COL_WRONG_CHARSET = 1922
const ER_ILLEGAL_SUBQUERY_OPTIMIZER_SWITCHES = 1923
const ER_QUERY_CACHE_IS_DISABLED = 1924
const ER_QUERY_CACHE_IS_GLOBALY_DISABLED = 1925
const ER_VIEW_ORDERBY_IGNORED = 1926
const ER_CONNECTION_KILLED = 1927
const ER_INTERNAL_ERROR = 1928
const ER_INSIDE_TRANSACTION_PREVENTS_SWITCH_SKIP_REPLICATION = 1929
const ER_STORED_FUNCTION_PREVENTS_SWITCH_SKIP_REPLICATION = 1930
const ER_QUERY_EXCEEDED_ROWS_EXAMINED_LIMIT = 1931
const ER_NO_SUCH_TABLE_IN_ENGINE = 1932
const ER_ERROR_LAST = 1932


const CR_ERROR_FIRST = 2000
